"""Build SlicePad.amxd — duplicate of ClaudeBar but loads slice-pad.html."""
import json
import os
import struct
...
OUT = os.path.join(SLICE_ROOT, "device", "SlicePad.amxd")
HTML_FILE = os.path.join(SLICE_ROOT, "device", "slice-pad.html").replace("\\", "/")
...
patcher = {
    "patcher": {
        ...
        "boxanimatetime": 0,
        "devicewidth": 700.0,
        "description": "SLICE Pad — pizza-wheel clip launcher with chat.",
        "digest": "SLICE Pad",
        "tags": "slice pad clip launcher",
        "boxes": [
            ...
            {"box": {"id": "obj-comment", "maxclass": "comment", "numinlets": 1, "numoutlets": 0,
                     ...
                     "text": "SLICE Pad — click a slice to fire its clip"}},
            {"box": {
                "id": "obj-web", "maxclass": "jweb",
                "numinlets": 1, "numoutlets": 1, "outlettype": [""],
                "patching_rect": [20.0, 100.0, 660.0, 180.0],
                "presentation": 1,
            ...
            {"box": {"id": "obj-cursor", "maxclass": "newobj", "numinlets": 1, "numoutlets": 0,
                     "patching_rect": [320.0, 320.0, 280.0, 22.0],
                     "text": "js " + CURSOR_JS}},
            {"box": {"id": "obj-min",  "maxclass": "newobj", "numinlets": 1, "numoutlets": 1,
                     "outlettype": [""], "patching_rect": [20.0, 320.0, 50.0, 22.0],
                     "text": "midiin"}},
